...
# The Licenses
The game has 3 types of licenses, which are this game's equivalent of a Battle Pass.

## The Hero License
This is the base "Battle Pass", gain experience from matches and from missions to progress through it. It has 70 levels, each offering rewards that range from Hero Tickets to Tuning Materials and a PUR costume. After reaching level 70, you can level the lic

## The Hero License and Pro License
This is the main "Battle Pass", and it's split into two rows: The Hero License (upper row) and the Pro License (lower row).
