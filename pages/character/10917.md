...
Tuning Slot Enhancement Parts are used to upgrade Normal Tuning Slots. Most players have an abundance of these parts, as the game gives them away very generously.
...
Universal Character Data may be used instead of usual character data in case if you lack it, but unfortunately, it can’t be used if you currently don’t own the character whose data you want to set
